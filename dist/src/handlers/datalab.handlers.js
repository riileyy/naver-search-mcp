 ...
 */
export const datalabToolHandlers = {
    datalab_search: (args) => {
 ...
 */
export async function handleSearchTrend(params) {
 ...
 */
export async function handleShoppingCategoryTrend(params) {
 ...
 */
export async function handleShoppingByDeviceTrend(params) {
 ...
 */
export async function handleShoppingByGenderTrend(params) {
 ...
 */
export async function handleShoppingByAgeTrend(params) {
 ...
 */
export async function handleShoppingKeywordsTrend(params) {
 ...
 */
export async function handleShoppingKeywordByDeviceTrend(params) {
 ...
 */
export async function handleShoppingKeywordByGenderTrend(params) {
 ...
 */
export async function handleShoppingKeywordByAgeTrend(params) {
